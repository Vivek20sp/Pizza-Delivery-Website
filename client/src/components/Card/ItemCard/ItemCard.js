    ...
    return ( 
        <div className="product__card__card">
            <div className="product__card">
                ...
                > 
                    {isHovered? <img src={props.item.ProductPhotos[0]} alt="item" className="product__img"/>: <img src= {props.item.ProductPhotos[1]} alt="item" className="product__img"/> }
                </div>
                <div className="product__card__detail">
                    ...
                    <div className="product__price">
                        <span>Rs {props.item.ProductPrice}</span>
                    </div>
