    ...
    return ( 
        <div className="wishcard">
            ...
            <div className="wish__item__image">
                <img src={props.item.ProductPhotos[0]} alt="item" className="wish__image"/>
            </div>
            <div className="wish__item__name">{props.item.ProductName}</div>
            <div className="wish__item__price">Rs {props.item.ProductPrice}</div>
