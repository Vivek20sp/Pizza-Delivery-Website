        ...
        <div className="product__detail__container">
            <div className="product__detail">
                <div className="product__main__detail">
                    <div className="product__name__main">{props.item.ProductName}</div>
                    <div className="product__detail__description">{props.item.ShortProductDescription}</div>
                    <div className="product__price__detail">${props.item.ProductPrice}</div>
                </div>
                    ...
                    <div className="product size">
                        <Box sx={{ minWidth: 100} }>
                            <FormControl fullWidth size="small">
                                ...
                                >
                                {size.map((s) => <MenuItem value={size}>{s}</MenuItem>)}
                                </Select>
                            </FormControl>
                        </Box>
                    </div>
